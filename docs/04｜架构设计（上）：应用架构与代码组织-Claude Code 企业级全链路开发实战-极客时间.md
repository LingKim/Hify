...
source: "https://time.geekbang.org/column/article/964066"
author:
published:
created: 2026-05-01
...
**第一个问题，** 你的模块之间是通过接口调用还是直接引用内部类？如果要把某个模块拆成独立服务，改动量大概多大？

**第二个问题，** 你的外部调用（数据库、第三方 API、消息队列）有没有做线程池隔离？如果某个外部服务卡了 30 秒，你的系统会怎样？
